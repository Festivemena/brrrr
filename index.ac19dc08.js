...
})({"eJFMo":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "ce947628ac19dc08";
"use strict";
...
},{}],"1l6Xg":[function(require,module,exports) {
...
async function getFormDetails(e) {
    ...
    try {
        ...
        if (!response.ok) {
            ...
            if (responseData.msg == "Incorrect Password") throw new Error("Incorrect Password");
            else if (responseData.msg == "User doesn't Exist") throw new Error("Email not found");
        ...
        } else localStorage.setItem("uvtkn", responseData.token);
        window.location.href = "dashboard.html";
    } catch (error) {
        console.log("Error:", error);
        console.error("Error:", error);
        document.querySelector("#login-error-btn").click();
        document.querySelector("#login-error-msg").textContent = `${error.message}`;
    }
}
document.querySelector("#reset-password-btn").addEventListener("click", (e)=>{
    ...
    document.querySelector("#send-reset-password").addEventListener("submit", async (e)=>{
        e.preventDefault();
        const emailRegex = /^[^\s@]+@[^\s@]+\.[^\s@]+$/i;
        if (!emailRegex.test(String(document.querySelector("#user-email-address").value))) {
            smallErr.textContent = "Invalid email address";
            smallErr.classList.contains("hidden") && smallErr.classList.remove("hidden");
        }
        try {
            const res = await fetchDataFromRoute("password", "post", {
                accountEmail: String(document.querySelector("#user-email-address").value)
            }, null);
            console.log(res);
            ...
            smallErr.classList.contains("hidden") && smallErr.classList.remove("hidden");
            document.querySelector("#sub-btn").setAttribute("disabled", true);
        } catch (error) {
...
},{"../../env":"gbRIV","../index":"8lqZg"}]},["eJFMo","1l6Xg"], "1l6Xg", "parcelRequire096c")

//# sourceMappingURL=index.ac19dc08.js.map

...
})({"alXRO":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "a3f139a9fc3c35ea";
"use strict";
...
},{}],"7m5fU":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _env = require("../../env");
var _index = require("../index");
var _addressesJson = require("../../addresses.json");
var _addressesJsonDefault = parcelHelpers.interopDefault(_addressesJson);
const { fetchDataFromRoute } = _index;
// import * as ADDRESSES from "../../addresses.json";
const proceedBTN = document.getElementById("proceed-btn");
const requestConfirmationBTN = document.getElementById("payment-confirmation-btn");
...
function verifyPaymentInfo(e) {
    ...
    console.log("Form is valid. Payment method:", paymentMethod[paymentMethod.value].textContent, "Amount:", amount);
}
async function showPaymentDetails(pM) {
    try {
        let currency = pM === "Ethereum" ? "ETH" : pM === "Bitcoin" ? "BTC" : "USDT";
        const { allAddresses } = await fetchDataFromRoute("addresses", "get", null, {
            currency
        });
        ...
        document.getElementById("txAmount").classList.add("bg-white", "text-gray-900", "opacity-80");
        proceedBTN.classList.add("hidden");
        const form = document.getElementById("deposit-form");
        const paymentDiv = document.createElement("div");
        paymentDiv.className = "block w-full rounded-lg space-y-2 bg-darkbg1 p-6 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700";
   ...
   `;
        ...
        form.insertBefore(paymentDiv, document.querySelector("#payment-confirmation-btn"));
...
function validateFormDetails() {
    ...
    if (!paymentFile.files.length > 0) return {
        error: true,
        msg: "You need to upload payment proof"
    };
    if (paymentFile.files.length > 0 && paymentFile.files[0].size > 3145728) return {
        error: true,
        msg: "File size exceeds the maximum allowed (3MB)."
    };
    return {
        error: false,
        file: paymentFile.files[0]
    };
}
...
function objectToFormData(obj) {
    ...
    for(const key in obj)if (Object.prototype.hasOwnProperty.call(obj, key)) formData.append(key, obj[key]);
    return formData;
}
document.addEventListener("DOMContentLoaded", function() {
    ...
    form.addEventListener("submit", async function(event) {
        ...
        if (validateForm.error) return console.log(validateForm.msg);
        ...
        const selectedOptionText = txMethod.options[txMethod.selectedIndex].textContent == "USDT (Tether)" ? "USDT" : txMethod.options[txMethod.selectedIndex].textContent;
        const txObject = {
            txAmount,
        ...
        try {
            const response = await fetchDataFromRoute("transactions", "post", formData, {
...
},{"../../env":"gbRIV","../index":"8lqZg","../../addresses.json":"gsChK","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"gsChK":[function(require,module,exports) {
module.exports = JSON.parse('{"ETHEREUM_ADDRESS":"0x1234567890987654321234567890","BITCOIN_ADDRESS":"0x1234567890987654321234567890","USDT_ADDRESS":"0x1234567890987654321234567890"}');

},{}]},["alXRO","7m5fU"], "7m5fU", "parcelRequire096c")

//# sourceMappingURL=deposit.fc3c35ea.js.map

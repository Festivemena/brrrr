 ...
 */ var o, i = this && this.__extends || (o = function(t, e) {
                ...
                var r = n(292), l = function(t) {
                    ...
                    return i(e, t), e.prototype.init = function() {
                        ...
                        this.animationInProcess = !0, this.el.classList.add("open"), (null === (t = null == this ? void 0 : this.el) || void 0 === t ? void 0 : t.ariaExpanded) && (this.el.ariaExpanded = "true"), this.content.classList.add("open"), this.content.classList.remove("hidden"), this.content.style.height = "0", setTimeout(function() {
                            e.content.style.height = "".concat(e.content.scrollHeight, "px"), e.fireEvent("beforeOpen", e.el), (0, r.dispatch)("beforeOpen.hs.collapse", e.el, e.el);
                        }), (0, r.afterTransition)(this.content, function() {
                            e.content.style.height = "", e.fireEvent("open", e.el), (0, r.dispatch)("open.hs.collapse", e.el, e.el), e.animationInProcess = !1;
                        });
                        ...
                        this.animationInProcess = !0, this.el.classList.remove("open"), (null === (t = null == this ? void 0 : this.el) || void 0 === t ? void 0 : t.ariaExpanded) && (this.el.ariaExpanded = "false"), this.content.style.height = "".concat(this.content.scrollHeight, "px"), setTimeout(function() {
                            ...
                            e.content.classList.add("hidden"), e.content.style.height = "", e.fireEvent("hide", e.el), (0, r.dispatch)("hide.hs.collapse", e.el, e.el), e.animationInProcess = !1;
            ...
            292: function(t, e) {
                ...
                e.isEnoughSpace = function(t, e, n, o, i) {
                    ...
                    var s = e.getBoundingClientRect(), r = i ? i.getBoundingClientRect() : null, l = window.innerHeight, a = r ? s.top - r.top : s.top, c = (i ? r.bottom : l) - s.bottom, u = t.clientHeight + o;
...
//# sourceMappingURL=faqs.0e7b8c01.js.map

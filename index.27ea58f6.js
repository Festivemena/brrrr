 ...
 */ Object.defineProperty(e, "__esModule", {
                ...
                var s = function() {
                    function t(t, e, s) {
                        this.el = t, this.options = e, this.events = s, this.el = t, this.options = e, this.events = {};
                    }
                    return t.prototype.createCollection = function(t, e) {
                        var s;
                        t.push({
                            id: (null === (s = null == e ? void 0 : e.el) || void 0 === s ? void 0 : s.id) || t.length + 1,
                            element: e
                        });
                ...
                var l = function(t) {
                    ...
                    return n(e, t), e.prototype.init = function() {
                        ...
                        this.createCollection(window.$hsCarouselCollection, this), this.inner && (this.calculateWidth(), this.loadingClassesRemove && ("string" == typeof this.loadingClassesRemove ? this.inner.classList.remove(this.loadingClassesRemove) : (t = this.inner.classList).remove.apply(t, this.loadingClassesRemove)), this.loadingClassesAdd && ("string" == typeof this.loadingClassesAdd ? this.inner.classList.add(this.loadingClassesAdd) : (e = this.inner.classList).add.apply(e, this.loadingClassesAdd))), this.prev && this.prev.addEventListener("click", function() {
                            s.goToPrev(), s.isAutoPlay && (s.resetTimer(), s.setTimer());
                        }), this.next && this.next.addEventListener("click", function() {
                            s.goToNext(), s.isAutoPlay && (s.resetTimer(), s.setTimer());
                        }), this.dots && this.dots.forEach(function(t, e) {
                            return t.addEventListener("click", function() {
                                s.goTo(e), s.isAutoPlay && (s.resetTimer(), s.setTimer());
                            });
                            ...
                            var t;
                            "string" == typeof s.afterLoadingClassesAdd ? s.inner.classList.add(s.afterLoadingClassesAdd) : (t = s.inner.classList).add.apply(t, s.afterLoadingClassesAdd);
                        }), this.el.classList.add("init"), this.el.addEventListener("touchstart", function(t) {
                            s.touchX.start = t.changedTouches[0].screenX;
                        }), this.el.addEventListener("touchend", function(t) {
                            s.touchX.end = t.changedTouches[0].screenX, s.detectDirection();
                        }), this.observeResize();
                        ...
                        var t = this;
                        this.slides.forEach(function(e, s) {
                            s === t.currentIndex ? e.classList.add("active") : e.classList.remove("active");
                        }), this.dots && this.dots.forEach(function(e, s) {
                            s === t.currentIndex ? e.classList.add("active") : e.classList.remove("active");
                        });
                        ...
                        var t = this.touchX, e = t.start, s = t.end;
                        s < e && this.goToNext(), s > e && this.goToPrev();
                        ...
                        var s = window.$hsCarouselCollection.find(function(e) {
                        ...
                        window.$hsCarouselCollection || (window.$hsCarouselCollection = []), document.querySelectorAll("[data-hs-carousel]:not(.--prevent-on-load-init)").forEach(function(t) {
                            window.$hsCarouselCollection.find(function(e) {
                                var s;
                                return (null === (s = null == e ? void 0 : e.element) || void 0 === s ? void 0 : s.el) === t;
                            }) || new e(t);
                        });
                    }, e;
                }(r(s(961)).default);
...
//# sourceMappingURL=index.27ea58f6.js.map

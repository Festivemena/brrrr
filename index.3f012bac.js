...
})({"i6zJE":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "aafbbcf43f012bac";
"use strict";
...
},{}],"8FFcC":[function(require,module,exports) {
...
document.addEventListener("DOMContentLoaded", async (e)=>{
    ...
    try {
        ...
        document.querySelector("#my-user-username").textContent = `Hi ${String(user.fullName).split(" ")[0]}`;
        document.querySelector("#my-user-aff-bal").textContent = `${String(user.accountCurrency)} ${Number(Number(affEd) + Number(MRPBalance)).toFixed(2)}`;
        ...
        if (accountGiftBoxStatus == "Inactive") {
            document.querySelector(".gift-box-request").textContent = `Activate GiftBox`;
            document.querySelector(".gift-box-request").addEventListener("click", async (e)=>{
                e.preventDefault();
                const res = await fetchDataFromRoute("users", "patch", {
        ...
        if (accountGiftBoxStatus == "Pending") {
            document.querySelector(".gift-box-request").textContent = `Pending | Cancel`;
            document.querySelector(".gift-box-request").addEventListener("click", async (e)=>{
                e.preventDefault();
                const res = await fetchDataFromRoute("users", "patch", {
        ...
        if (accountGiftBoxStatus == "Active") {
            document.querySelector(".gift-box-request").textContent = `GiftBox Activated`;
            document.querySelector(".gift-box-request").classList.add("!bg-[#28be39]");
            document.querySelector(".gift-box-request").setAttribute("disabled", true);
        }
    } catch (error) {
        console.log(error);
    }
    document.querySelectorAll(".sign-out-acc").forEach((s)=>s.addEventListener("click", async (e)=>{
            e.preventDefault();
...
},{"../index":"8lqZg"}]},["i6zJE","8FFcC"], "8FFcC", "parcelRequire096c")

//# sourceMappingURL=index.3f012bac.js.map
